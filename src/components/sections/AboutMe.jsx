                ...
                <Flex gap='5' direction='column'>
                    ...
                    <Flex>
                        <Flex gap='2' direction='column' style={{padding: '5%', width: '60%'}}>
                            ...
                            <Text size='7' style={{padding: '1%', fontSize: '150%'}}>
                                I am a passionate <Strong>Full stack developer</Strong> dedicated to crafting exceptional software solutions that effectively address people's needs. With over <Strong>three years of experience in programming</Strong>, I have honed my skills in <Strong>problem analysis</Strong> and <Strong>strategic development</Strong> to deliver impactful solutions for the community.
                            </Text>
                            <Text size='7' style={{padding: '1%', fontSize: '150%'}}>
                                Beyond my professional endeavors, I find joy in basketball and immerse myself in the captivating world of music. These passions fuel my creativity and inspire me to <Strong>think outside the box</Strong>.
                            </Text>
                            <Text size='7' style={{padding: '1%', fontSize: '150%'}}>
                                I am thrilled at the prospect of collaborating with you, leveraging my expertise and enthusiasm to create <Strong>innovative solutions</Strong> that exceed expectations. Let's embark on this exciting journey together!
                            </Text>
                        </Flex>
                    ...
                    <Box align='center'>
                        <ScrollLink to="contact" smooth={true} duration={500}>
                            <Button radius="medium" size='4' style={{width: '20%', fontWeight:'350%'}}>CONTACT</Button>
                        </ScrollLink>
                    </Box>
                    <Separator size='4' />
                </Flex>
